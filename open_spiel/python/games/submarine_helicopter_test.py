...
# Lint as python3
"""Tests for Python Submarine Helicopter Game."""
...
from open_spiel.python.games import submarine_helicopter # pylint: disable=unused-import
from open_spiel.python.observation import make_observation
import pyspiel


class SubmarineHelicopterTest(absltest.TestCase):
  ...
  def test_consistent(self):
    ...
    py_game = pyspiel.load_game("python_submarine_helicopter")
